...
import type { NavItem, ViewState } from '../types';
      ...
      <div className="flex h-full flex-col justify-between p-4">
            ...
            {NAV_ITEMS.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-colors group w-full text-left ${isActive
        ...
        <div className="flex flex-col gap-2">
          ...
          <button
            ...
            className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-colors w-full text-left ${currentView === 'settings'
                ? 'bg-primary/10 text-primary dark:bg-[#232f48] dark:text-white'
                : 'text-[#637588] dark:text-[#92a4c9] hover:bg-[#f0f2f5] dark:hover:bg-[#1e2a40]'
              }`}
          >
